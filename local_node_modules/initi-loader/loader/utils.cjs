...
function executeLoad(/*String*/path, /*LoadingFile*/loadingFile) {
    ...
    switch (loadingFile.contentType) {
        ...
        case Type.text:
            ...
            break;
        case Type.css:
            loadBinSync(path, boundLoad, boundError, { encoding: "utf8" });
            break;
    }
}
...
function loadBinSync(/*String*/path, /*Function*/callback, /*Function*/error, options = {}) {
    try {
        const binBuffer = fs.readFileSync(path, options.encoding);
        const event = {
            target: {
                response: binBuffer,
            }

export default async function run() {
    const MESSAGES = {
        success: "Test 8: all system modules loaded successfully",
        error: "Test 8: failed to load system modules",
    }
    console.debug("::Starting test_8.js::Loading system modules::");
    ...
    async function handleConfig() {
        ...
        if (config) {
            ...
            console.debug("Test 8: core/configs/gui has been oaded");
        } else {
    ...
    async function handlePrerequisiteModules() {
        ...
        await loadBulk(prerequisiteModules, 
            () => console.debug("Test 8: prerequisiteModules has been loaded"), 
            (err) => {
        ...
        gi18n.init({
            ...
            untranslatedHandler: function (obj) {
                console.debug("There is no translation for string: \"" + obj.request + "\" to language: \"" + obj.language + "\"");
            }
        });
    ...
    async function handleProviderSystemModule() {
        ...
        await loadBulk(providerSystemModules,
            () => console.debug("Test 8: providerSystemModules has been loaded"),
            (err) => {
                console.error(MESSAGES.error, err);
                throw new Error(MESSAGES.error);
            },
    ...
    async function handleOtherModules() {
        ...
        await loadBulk(otherModules,
            () => console.debug("Test 8: otherModules has been loaded"), 
            (err) => {
                console.error(MESSAGES.error, err);
                throw new Error(MESSAGES.error);
            },
    ...
    async function handleCoreGuiModules() {
        ...
        await loadBulk(coreGuiModules,
            () => console.debug("Test 8: coreGuiModules has been loaded"),
            (err) => {
                console.error(MESSAGES.error, err);
                throw new Error(MESSAGES.error);
            },
